...
class LeftText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      Padding(padding: EdgeInsets.only(left: screenSize.width>800? 100:30),
      child:Text(
        'GUTS',
        textAlign: TextAlign.left,
        softWrap: true,
      ...
      Padding(padding: EdgeInsets.only(left: screenSize.width>800? 200:50),
      child:Text(
        'SPORT',
        textAlign: TextAlign.left,
        softWrap: true,
      ...
      Padding ( padding: EdgeInsets.only(top: screenSize.width>800?30:15,bottom: screenSize.width>800?70:15),
      child:Text(
